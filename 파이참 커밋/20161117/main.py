...
class Explode:
    ...
    def __init__(self):
        ...
        self.life_time = 0
        self.total_frames = 0.0
        self.image = load_image('Resource\\Enemy\\Explode.png')
...
def enter():
    global player,map,attack,enemy_1,enemy_2,enemy_3,enemy_4,explode_list,score
    ...
    explode_list = [Explode() for i in range(1)]
    attack = Attack()
