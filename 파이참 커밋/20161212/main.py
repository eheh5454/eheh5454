...
class Time: ##객체 생성
    ...
    def create_boss(self):
        if (score.score >= 250 and self.boss_live == False):
            self.boss_live = True
            new_boss = Boss()
...
class SpecialAttack: ##필살기
    ...
    def __init__(self,x,y):
        ...
        if SpecialAttack.image == None:
            SpecialAttack.image = load_image('AyinSpecialAttack1.PNG')
...
def enter():
    global time,SpecialAttack_List,Boss_List,player,map,attack,Enemy_1,Enemy_2,Enemy_3,Enemy_4,score,Explode_List,EnemyAttack_List,Attack_List,attack2,Attack_List2,specialattack
...
def exit():
    global time,SpecialAttack_List,Boss_List,player,map,attack,Enemy_1,Enemy_2,Enemy_3,Enemy_4,score,Explode_List,EnemyAttack_List,Attack_List,Attack_List2,attack2,specialattack
    del(time)
    del(Boss_List)
    del(player)
    del(map)
