...
class Time: ##객체 생성
    ...
    def update(self,frame_time):
        ...
        self.time_5 += frame_time
        self.time_1 += frame_time
        self.time_2 += frame_time
        self.time_3 += frame_time
        self.time_4 += frame_time
        self.create_enemy1()
        self.create_enemy2()
        self.create_enemy3()
        self.create_enemy4()
...
class Boss:
    ...
    ATTACK_CREATE_TIME = 1


    image = None

    LEFT_RUN, UP_RUN, DOWN_RUN, UP_STAND, DOWN_STAND = 0, 1, 2, 3, 4
    ...
    def update(self, frame_time):
            ...
            self.y += (self.ydir * distance)
            self.handle_state[self.state](self)
            self.missile_count += frame_time * self.ATTACK_CREATE_TIME
            if self.missile_count > 2 :
                self.missile_count = 0
                boss_attack1 = bossattack(self.x - 70, self.y + 250)
                boss_attack2 = bossattack(self.x - 200, self.y + 180)
                boss_attack3 = bossattack(self.x - 230, self.y + 45)
                boss_attack4 = bossattack(self.x - 110, self.y - 170)
                boss_attack5 = bossattack_down(self.x - 110, self.y - 170)
                boss_attack6 = bossattack_up(self.x - 110, self.y - 170)
                boss_attack7 = bossattack(self.x - 50, self.y - 170)
                boss_attack8 = bossattack_down(self.x - 50, self.y - 150)
                boss_attack9 = bossattack_up(self.x - 50, self.y - 190)
                boss_attack10 = bossattack(self.x + 10, self.y - 170)
                boss_attack11 = bossattack_down(self.x + 10, self.y - 130)
                boss_attack12 = bossattack_up(self.x + 10, self.y - 210)
                Boss_Attack_List.append(boss_attack1)
                Boss_Attack_List.append(boss_attack2)
                Boss_Attack_List.append(boss_attack3)
                Boss_Attack_List.append(boss_attack4)
                Boss_Attack_List.append(boss_attack5)
                Boss_Attack_List.append(boss_attack6)
                Boss_Attack_List.append(boss_attack7)
                Boss_Attack_List.append(boss_attack8)
                Boss_Attack_List.append(boss_attack9)
                Boss_Attack_List.append(boss_attack10)
                Boss_Attack_List.append(boss_attack11)
                Boss_Attack_List.append(boss_attack12)
            

    def draw(self):
             self.image.clip_draw(self.frame * 450, 0, 450, 500, self.x, self.y)

    def get_bb(self):
        return self.x - 180, self.y -250, self.x, self.y + 250
...
class Player: ##플레이어 캐릭터
    ...
    def __init__(self):
        ...
        if self.image == None:
            self.image = load_image('Resource\\player\\Ayin.png')
    ...
    def draw(self):
        ...
        self.font2.draw(50,650,'HP: %d' % (self.hp))

    def get_bb(self):
        return self.x + 20, self.y -10, self.x + 25, self.y + 10
    ...
    def get_special2(self):
        newattack = SpecialAttack(self.x + 50, self.y - 150)
        SpecialAttack_List.append(newattack)

    def get_special3(self):
        newattack = SpecialAttack(self.x + 50, self.y + 150)
        SpecialAttack_List.append(newattack)
...
class Attack2: ##화살모양 공격
    ...
    def get_bb(self):
        return  self.x - 10, self.y -15, self.x + 45, self.y + 15

    def draw_bb(self):
        draw_rectangle(*self.get_bb())
        
class SpecialAttack: ##필살기
    ...
    def __init__(self,x,y):
        ...
        if SpecialAttack.image == None:
            SpecialAttack.image = load_image('Resource\\SpecialAttack\\AyinSpecialAttack.png')
        if SpecialAttack.specialattack_sound == None:
            SpecialAttack.specialattack_sound = load_wav('Resource\\Sound\\AyinSpecialAttack.wav')
            SpecialAttack.specialattack_sound.set_volume(120)

    def specialattack(self):
        self.specialattack_sound.play()
    ...
    def update(self, frame_time):
        ...
        self.total_frames += SpecialAttack.FRAMES_PER_ACTION * SpecialAttack.ACTION_PER_TIME * frame_time
...
class bossattack:
    ...
    def __init__(self, x, y):
        self.x, self.y = x, y
        self.xdir = -1
        if bossattack.image == None:
            bossattack.image = load_image('Resource\\Missile\\bossattack.png')

    def update(self, frame_time):
        distance = bossattack.RUN_SPEED_PPS * frame_time
        self.x += (self.xdir * distance)
    ...
    def get_bb(self):
        return self.x - 25, self.y -20, self.x -20, self.y + 20

    def draw_bb(self):
        draw_rectangle(*self.get_bb())


class bossattack_down:
    ...
    def __init__(self, x, y):
        ...
        self.xdir = -1
        self.ydir = -0.3
        if bossattack_down.image == None:
            bossattack_down.image = load_image('Resource\\Missile\\bossattack.png')

    def update(self, frame_time):
        distance = bossattack_down.RUN_SPEED_PPS * frame_time
        self.x += (self.xdir * distance)
        self.y += (self.ydir * distance)
...
class bossattack_up:
    ...
    def __init__(self, x, y):
        ...
        self.xdir = -1
        self.ydir = 0.3
        if bossattack_up.image == None:
            bossattack_up.image = load_image('Resource\\Missile\\bossattack.png')

    def update(self, frame_time):
        distance = bossattack_up.RUN_SPEED_PPS * frame_time
        self.x += (self.xdir * distance)
        self.y += (self.ydir * distance)
...
class EnemyAttack:
    ...
    def get_bb(self):
        return self.x - 10, self.y -10, self.x - 5, self.y + 10
...
class UI: ##점수
    ...
    def draw(self):
        self.font.draw(50,700,'Score: %d' % (self.score))
...
def enter():
    global time,SpecialAttack_List,Boss_List,Boss_Attack_List,player,map,attack,Enemy_1,Enemy_2,Enemy_3,Enemy_4,ui,Explode_List,EnemyAttack_List,Attack_List,attack2,Attack_List2,specialattack
...
def exit():
    global time,SpecialAttack_List,Boss_List,Boss_Attack_List,player,map,attack,Enemy_1,Enemy_2,Enemy_3,Enemy_4,ui,Explode_List,EnemyAttack_List,Attack_List,Attack_List2,attack2,specialattack
    del(time)
    del(Boss_List)
    del(Boss_Attack_List)
    del(player)
    del(map)
    del(Enemy_1)
    del(Enemy_2)
...
def update(frame_time):
    ...
    for bossattack in Boss_Attack_List:
        bossattack.update(frame_time)
        out_side = bossattack.update(frame_time)
        if out_side == True :
            Boss_Attack_List.remove(bossattack)

    for bossattack_down in Boss_Attack_List:
        bossattack_down.update(frame_time)
        out_side = bossattack_down.update(frame_time)
        if out_side == True :
            Boss_Attack_List.remove(bossattack_down)

    for bossattack_up in Boss_Attack_List:
        bossattack_up.update(frame_time)
        out_side = bossattack_up.update(frame_time)
        if out_side == True :
            Boss_Attack_List.remove(bossattack_up)
...
##필살기와 적군 미사일 충돌
    for specialattack in SpecialAttack_List:
        for enemymissile in EnemyAttack_List:
            if collide(specialattack,enemymissile):
                EnemyAttack_List.remove(enemymissile)
...
##필살기와 보스 미사일 충돌
    for specialattack in SpecialAttack_List:
        for bossattack in Boss_Attack_List:
             if collide(specialattack, bossattack):
                Boss_Attack_List.remove(bossattack)

##필살기와 보스 충돌
    for specialattack in SpecialAttack_List:
        for boss in Boss_List:
            if collide(specialattack, boss):
                if (boss.LIFE == 1):
                    boss.hp_drop(1)
                if (boss.LIFE == 0):
                    ...
                    specialattack.attackcount += 2
                    ui.score_get_b()
                    boss_explode = Explode(boss.x, boss.y)
                    Explode_List.append(boss_explode)


#공격과 보스 충돌
    for attack in Attack_List:
        for boss in Boss_List:
            if collide(attack, boss):
                if (boss.LIFE == 1):
                    boss.hp_drop(1)
                if (boss.LIFE == 0):
                    Boss_List.remove(boss)
...
##필살기와 적군 충돌
    for specialattack in SpecialAttack_List:
        for enemy1 in Enemy_1:
            if collide(specialattack, enemy1):
                Enemy_1.remove(enemy1)
                ui.score_get()
                enemy_one_explode = Explode(enemy1.x, enemy1.y)
                Explode_List.append(enemy_one_explode)
    ...
    for specialattack in SpecialAttack_List:
        for enemy2 in Enemy_2:
            if collide(specialattack, enemy2):
                Enemy_2.remove(enemy2)
                ui.score_get()
                enemy_two_explode = Explode(enemy2.x, enemy2.y)
                Explode_List.append(enemy_two_explode)
    ...
    for specialattack in SpecialAttack_List:
        for enemy3 in Enemy_3:
            if collide(specialattack, enemy3):
                Enemy_3.remove(enemy3)
                ui.score_get()
                enemy_three_explode = Explode(enemy3.x, enemy3.y)
                Explode_List.append(enemy_three_explode)
    ...
    for specialattack in SpecialAttack_List:
        for enemy4 in Enemy_4:
            if collide(specialattack, enemy4):
                Enemy_4.remove(enemy4)
                ui.score_get()
                enemy_four_explode = Explode(enemy4.x, enemy4.y)
                Explode_List.append(enemy_four_explode)
...
def draw(frame_time):
    ...
    for bossattack_down in Boss_Attack_List:
        bossattack_down.draw()
        #bossattack_down.draw_bb()

    for bossattack_up in Boss_Attack_List:
        bossattack_up.draw()
        #bossattack_up.draw_bb()
